...
public class RoutineRequestDto {
    ...
    @Builder
    public RoutineRequestDto(String name, Boolean is_active, Integer priority, String repeat_condition, List<String> sub_todo, Integer orders, Category category, Reminder reminder) {
        this.name = name;
